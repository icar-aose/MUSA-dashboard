...
//			 exitCodeArray = exitCodesGate.split(",");
	...
	function addMessage(xPos,yPos,idMessage,name,urlMessage,typeNewMessage) {
		console.log("OPERATION typeNewMessage:-->"+typeNewMessage);
					var nameMessage="Basic Message";
					var typeMessage="Default";
					if(typeNewMessage==="1")
						typeMessage="Output";
					else if(typeNewMessage==="2")
						typeMessage="Input";
					if(name!==undefined)
						nameMessage=name;
					...
					console.log("OPERATION TYPEMESSAGE:-->"+typeMessage);
					message.attr({
					text: {
				            text: nameMessage
				        },
